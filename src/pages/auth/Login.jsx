...
function Login(){
    return (
        <main className="flex flex-row w-screen overflow-y-hidden font-nunito">
            <section className="w-full md:w-1/2 h-screen flex flex-col px-20 py-12 bg-[#c9cce011] md:bg-primary overflow-y-hidden">
                <a className="self-center md:self-start text-primary md:text-white text-[29px] font-bold" href="/">Zwallet</a>
                <div className="hidden md:inline-block">
                    <img className="w-[100%] max-w-[400px] h-auto " src={imageGroup} alt="image hero" />
                </div>
            ...
            <section className="absolute top-[25%] md:static md:w-1/2 h-screen flex flex-col rounded-[20px] md:rounded-none gap-y-7 px-5 md:px-12 py-12 bg-white">
                ...
                <form className="md:w-[75%] flex flex-col gap-y-5" action="">
                    <div className="flex flex-row border-b-[1.5px] border-[#A9A9A999] py-2 mt-5">
                        ...
                        <input className="w-[100%] outline-none"  type="mail" required placeholder="Enter your e-mail" />
                    </div>
                    <div className="flex flex-row border-b-[1.5px] border-[#A9A9A999] py-2 mt-5" >
                        <div className="w-[12%] md:w-[8%]">
                    ...
                    <button className="bg-[#88888f3f] hover:bg-[#88888fb4] hover:text-[#505055] text-[#88888F] rounded-[8px] p-4 mt-10" type="submit">Login</button>
