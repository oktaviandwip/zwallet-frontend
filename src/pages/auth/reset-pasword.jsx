            ...
            <section className="absolute top-[25%] md:static md:w-1/2 h-screen flex flex-col rounded-[20px] md:rounded-none gap-y-7 px-5 md:px-12 py-12 bg-white">
                ...
                <form className="md:w-[75%] flex hidden flex-col gap-y-5" action="">
                    ...
                    <div className="flex flex-row border-b-[1.5px] border-[#A9A9A999] py-2 mt-5" >
                        ...
                        <input className="w-[100%] outline-none" type="password" name="new-password" id="" placeholder="Create new password" />
                        <button type="button">
                    ...
                    <div className="flex flex-row border-b-[1.5px] border-[#A9A9A999] py-2 mt-5" >
                        ...
                        <input className="w-[100%] outline-none" type="password" name="confirm-new-password" id="" placeholder="Create new password" />
                        <button type="button">
                            <img src={iconEyeCrossed} alt="" />
                        </button>
                    </div>
